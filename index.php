...
<input type="text" name="username" value="<?php print $username;?>" maxlength="10"></td></tr>
<tr class="buildings"><td>Password</td><td>
<input type="password" name="password" value="<?php print $password;?>" maxlength="10"></td></tr>
<tr class="buildings"><td colspan="2" align="center">
